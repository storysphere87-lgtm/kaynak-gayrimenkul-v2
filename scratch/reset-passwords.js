...
async function resetPasswords() {
  console.log("=== Supabase Şifre Resetleme Operasyonu Başladı ===");
  ...
  for (const user of users) {
    console.log(`Şifre güncelleniyor: ${user.email}...`);
    ...
    if (error) {
      ...
      console.log(`✅ Başarılı (${user.email}) -> Şifre 'kaynakgayrimenkul123' olarak güncellendi.`);
    }
  }
}
